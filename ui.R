...
ui <- page_navbar(
    ...
    page_fluid(
      ...
      layout_sidebar(
        sidebar = sidebar(
          ...
          card(
            card_body(plotOutput("VOTES_DIST_PLOT", height = 240),
              class = "p-0"
            ),
            full_screen = TRUE
          )
            ...
            card(
              ...
              card_body(
                ...
                conditionalPanel(
                  ...
                  div(
                    DTOutput("CAT_FREQ_TAB_ROUND", height = "100%"),
                    # style = "font-size:90%"
                  ),
                ),
                conditionalPanel(
                  ...
                  div(
                    DTOutput("CAT_FREQ_TAB_PICKER", height = "100%"),
                    # style = "font-size:90%"
                  ),
                )
              )
      ...
      page_fillable(
        layout_sidebar(
          ...
          card(
            full_screen = TRUE,
            card_header(
              htmlOutput("REG_TITLE", inline = TRUE),
              popover(
                bsicons::bs_icon("gear"),
                # awesomeRadio(
  ...
  nav_spacer(),
  nav_item(h4(
    "Itty Bitty Ditties [data explorer]",
